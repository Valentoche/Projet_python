...
def initialiser_labyrinthe(participants, plateau, carte_supplementaire, nb_tours, rangee_interdite, direction_interdite, duree_objet):
    ...
    """
    return {"Labyrinthe":plateau, "Carte_sup": carte_supplementaire, 'participants':participants, 'nb_tour': nb_tours+1, 'duree_objet':duree_objet, 'rangee_interdite':rangee_interdite, 'direction_interdite':direction_interdite}
